...
$("#dropofftime-submit").click(function() {
  ...
  if (startTime.includes("null") || endTime.includes("null") || location == "blank"){
...
$(document).ready(function() {
  ...
  if(currItem != "") {
    tempItem = JSON.parse(localStorage.getItem(currItem));
    if(tempItem.startTime && !tempItem.startTime.includes("null")) {
    ...
    if(tempItem.endTime && !tempItem.startTime.includes("null")) {
